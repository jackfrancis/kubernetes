...
func TestGetCapacity(t *testing.T) {
	...
	cadvisorError := &cadvisortest.Mock{}
	cadvisorError.On("RootFsInfo").Return(cadvisorapiv2.FsInfo{}, errors.New("Unable to get rootfs data from cAdvisor interface"))
	cases := []struct {
		name                                string
		...
		},
		{
			...
			cm: &containerManagerImpl{
				cadvisorInterface: cadvisorError,
				capacity:          v1.ResourceList{},
			},
